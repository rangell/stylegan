...
if 1:
    ...
    print('made it to train.py')

    desc          = 'sgan'                                                                 # Description string included in result subdir name.
    train         = EasyDict(run_func_name='training.training_loop_copy.training_loop')         # Options for training loop.
    G             = EasyDict(func_name='training.networks_stylegan.G_style')               # Options for generator network.
    D             = EasyDict(func_name='training.networks_stylegan.D_basic')               # Options for discriminator network.
    E             = EasyDict(func_name='training.networks_stylegan.E_basic')               # Options for encoder network.
    ...
    E_loss        = EasyDict(func_name='training.loss.E_wgan')                  # Options for encoder loss.
    ...
    # Dataset.
    desc += '-images1024x1024';     dataset = EasyDict(tfrecord_dir='images1024x1024');                 train.mirror_augment = True
    ...
    # Number of GPUs.
    #desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 16, 8: 16, 16: 16, 32: 16, 64: 8, 128: 8, 256: 4, 512: 2}
    #desc += '-2gpu'; submit_config.num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}
    desc += '-4gpu'; submit_config.num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 32, 8: 32, 16: 32, 32: 32, 64: 32, 128: 16}
...
if 0:
    ...
    desc += '-preset-v2-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 64, 8: 64, 16: 64, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
...
def main():
    ...
    kwargs.update(G_args=G, D_args=D, E_args=E, G_opt_args=G_opt, D_opt_args=D_opt, E_opt_args=E_opt, G_loss_args=G_loss, D_loss_args=D_loss, E_loss_args=E_loss)
